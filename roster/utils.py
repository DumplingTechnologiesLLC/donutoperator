...
def store_in_cache(queryset, date):
	...
	cache.get("{}{}1".format(QUERYSET_KEY, date), queryset[0:offset])
	cache.get("{}{}2".format(QUERYSET_KEY, date), queryset[offset:(2 * offset)])
	cache.get("{}{}3".format(QUERYSET_KEY, date), queryset[(offset * 2):(offset * 3)])
	cache.get("{}{}4".format(QUERYSET_KEY, date), queryset[offset * 3:])
