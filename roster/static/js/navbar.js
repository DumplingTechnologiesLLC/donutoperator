...
var nav_app = new Vue({
    ...
    methods: {
        ...
        submitTip: function() {
            /*Prompts the user for a tip and submits it.
            */
            $.confirm({
                title: 'Submit a tip',
                content: `
                ...
                <textarea style="height:200px" class="tag form-control" placeholder="Tell us about the shooting. Please provide sources if possible." required></textarea>
                </div>
                </form>`,
                buttons: {
                    formSubmit: {
                        ...
                        btnClass: 'btn-blue',
                        action: function () {
                            var tipText = this.$content.find('.tag').val();
                            if(!tipText){
                                $.alert('Please provide further details');
                                return false;
                            }
                            data = {
                                csrfmiddlewaretoken: CSRFMIDDLEWARETOKEN,
                            ...
                            $.post(SUBMIT_TIP_URL, data).done(function() {
                                $.alert({
                                    title:"Success",
